...
const commonPlugin = [
    ...
    new webpack.LoaderOptionsPlugin({
        options: {
            postcss: function(){
                return [
                    require("autoprefixer")({//调用autoprefixer插件  智能添加 CSS 前缀的插件。
    ...
    module: {
        rules: [
            { /* 用来解析vue后缀的文件 */
                ...
                test: /\.(png|jpg|gif|jpeg|woff|svg|eot|ttf)\??.*$/, //处理css文件中的背景图片
                loader: 'url-loader?limit=8192&name=/static/assets/[name]-[hash:4].[ext]'
                ...
                use: ExtractTextPlugin.extract({
                    ...
                    use: "css-loader?minimize!postcss-loader",//modules or minimize 压缩
                    publicPath: "/dist"
                })
            }
        ],
